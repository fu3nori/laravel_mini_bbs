...
<p>URLをfoovar(設置位置)/start/viewとするとBBSの投稿一覧が表示され、閲覧出来ます。</p>
<p>管理者アカウントでログインしてからURLをfoovar(設置位置)/adminとすると、投稿された記事の編集や削除が出来ます</p>
<p>/public/.htaccessのRewriteBaseはローカル用なので削除してください<br>
ex:RewriteBase /laravel_mini_bbs/ → 
